...
export default function GitHubStreakWidget({ username }: { username: string }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8 bg-linear-to-br from-gray-900 via-gray-800 to-gray-900">
      <Card>
        {/* Header Section */}
        <div className="flex items-center space-x-6 mb-10">
          {" "}
          {/* Increased space-x and mb */}
          <div className="w-16 h-16 bg-linear-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 shrink-0">
            <svg
...
function Card({
  ...
  return (
    <div
      className={
        "bg-linear-to-br from-gray-800/95 to-gray-900/95 backdrop-blur-xl " +
...
function Status({ active, message }: { active: boolean; message: string }) {
  return (
    <div
      className={`flex items-center space-x-6 p-6 rounded-xl transition-all duration-300 ${
